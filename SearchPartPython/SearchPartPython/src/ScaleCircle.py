...
class ScaleCircle(object):
    ...
    def scale(self):  
        ...
        if scale_factor<40 or scale_factor>80:
            scale_factor=False
        #cv2.drawContours(imc,cnt,-1,(0,0,255),cv2.cv.CV_FILLED)       
...
#I=cv2.imread('/home/bernifoellmer/Studium/SearchPartPython/SearchPartPython/SearchPartPython/SearchPartPython/data/SOT223_images/SAM_0595.JPG')   
