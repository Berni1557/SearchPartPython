...
#endif
#include <math.h>
#define __PYX_HAVE__rgrowmod
#define __PYX_HAVE_API__rgrowmod
#include <list>
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'rgrowmod' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "rgrowmod"
int __pyx_module_is_main_rgrowmod = 0;

/* Implementation of 'rgrowmod' */
...
static char __pyx_k_dest1[] = "dest1";
static char __pyx_k_numpy[] = "numpy";
static char __pyx_k_range[] = "range";
static char __pyx_k_import[] = "__import__";
static char __pyx_k_source1[] = "source1";
static char __pyx_k_rgrowmod[] = "rgrowmod";
static char __pyx_k_threshold[] = "threshold";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_rgrow_func[] = "rgrow_func";
static char __pyx_k_RuntimeError[] = "RuntimeError";
static char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static char __pyx_k_home_bernifoellmer_Studium_Sear[] = "/home/bernifoellmer/Studium/SearchPartPython/SearchPartPython/SearchPartPython/SearchPartPython/src/cpp/region_growing/src/wrap_rgrow.pyx";
...
static PyObject *__pyx_n_s_dest1;
static PyObject *__pyx_kp_s_home_bernifoellmer_Studium_Sear;
...
static PyObject *__pyx_n_s_rgrow_func;
static PyObject *__pyx_n_s_rgrowmod;
...
/* Python wrapper */
static PyObject *__pyx_pw_8rgrowmod_1rgrow_func(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8rgrowmod_1rgrow_func = {"rgrow_func", (PyCFunction)__pyx_pw_8rgrowmod_1rgrow_func, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8rgrowmod_1rgrow_func(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("rgrow_func (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_source1)) != 0)) kw_args--;
...
static PyObject *__pyx_pf_8rgrowmod_rgrow_func(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_source1, PyArrayObject *__pyx_v_dest1, PyObject *__pyx_v_sx, PyObject *__pyx_v_sy, PyObject *__pyx_v_threshold) {
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_source1;
  __Pyx_Buffer __pyx_pybuffer_source1;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("rgrow_func", 0);
  __pyx_pybuffer_source1.pybuffer.buf = NULL;
  __pyx_pybuffer_source1.refcount = 0;
  __pyx_pybuffernd_source1.data = NULL;
  __pyx_pybuffernd_source1.rcbuffer = &__pyx_pybuffer_source1;
  __pyx_pybuffer_dest1.pybuffer.buf = NULL;
  __pyx_pybuffer_dest1.refcount = 0;
  __pyx_pybuffernd_dest1.data = NULL;
  __pyx_pybuffernd_dest1.rcbuffer = &__pyx_pybuffer_dest1;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_source1.rcbuffer->pybuffer, (PyObject*)__pyx_v_source1, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 3, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_source1.diminfo[0].strides = __pyx_pybuffernd_source1.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_source1.diminfo[0].shape = __pyx_pybuffernd_source1.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_source1.diminfo[1].strides = __pyx_pybuffernd_source1.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_source1.diminfo[1].shape = __pyx_pybuffernd_source1.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_source1.diminfo[2].strides = __pyx_pybuffernd_source1.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_source1.diminfo[2].shape = __pyx_pybuffernd_source1.rcbuffer->pybuffer.shape[2];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dest1.rcbuffer->pybuffer, (PyObject*)__pyx_v_dest1, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __pyx_t_6 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_pybuffernd_source1.diminfo[0].shape;
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_pybuffernd_source1.diminfo[0].shape)) __pyx_t_6 = 0;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_pybuffernd_source1.diminfo[1].shape;
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_source1.diminfo[1].shape)) __pyx_t_6 = 1;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_pybuffernd_source1.diminfo[2].shape;
  ...
  __pyx_t_6 = -1;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_pybuffernd_dest1.diminfo[0].shape;
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_7 >= __pyx_pybuffernd_dest1.diminfo[0].shape)) __pyx_t_6 = 0;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_pybuffernd_dest1.diminfo[1].shape;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_source1.rcbuffer->pybuffer);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_dest1, __pyx_k_dest1, sizeof(__pyx_k_dest1), 0, 0, 1, 1},
  {&__pyx_kp_s_home_bernifoellmer_Studium_Sear, __pyx_k_home_bernifoellmer_Studium_Sear, sizeof(__pyx_k_home_bernifoellmer_Studium_Sear), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_rgrow_func, __pyx_k_rgrow_func, sizeof(__pyx_k_rgrow_func), 0, 0, 1, 1},
  {&__pyx_n_s_rgrowmod, __pyx_k_rgrowmod, sizeof(__pyx_k_rgrowmod), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initrgrowmod(void); /*proto*/
PyMODINIT_FUNC initrgrowmod(void)
#else
PyMODINIT_FUNC PyInit_rgrowmod(void); /*proto*/
PyMODINIT_FUNC PyInit_rgrowmod(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_rgrowmod(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("rgrowmod", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_rgrowmod) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "rgrowmod")) {
      if (unlikely(PyDict_SetItemString(modules, "rgrowmod", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rgrow_func, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rgrowmod", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init rgrowmod");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
